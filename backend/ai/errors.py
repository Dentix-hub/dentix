...
class AIException(Exception):
    ...
    def __init__(self, message: str, code: str = "ai_error", debug_info: Optional[Dict[str, Any]] = None):
...
class AIValidationError(AIException):
    ...
    def __init__(self, message: str, code: str = "validation_error", debug_info: Optional[Dict] = None):
...
class AINotFoundError(AIException):
    ...
    def __init__(self, message: str, code: str = "not_found", debug_info: Optional[Dict] = None):
        super().__init__(message, code=code, debug_info=debug_info)

class AIPermissionError(AIException):
    """User does not have permission to execute this tool."""
    def __init__(self, message: str = "ليس لديك صلاحية للقيام بهذا الإجراء.", debug_info: Optional[Dict] = None):
...
class AIBusinessError(AIException):
    ...
    def __init__(self, message: str, code: str = "business_rule_violation", debug_info: Optional[Dict] = None):
        super().__init__(message, code=code, debug_info=debug_info)

class AIExecutionError(AIException):
    """Unexpected error during tool execution (e.g. DB crash, unknown error)."""
    def __init__(self, message: str, original_error: Exception = None, code: str = "execution_failed", debug_info: Dict = None):
