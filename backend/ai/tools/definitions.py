...
def register_default_tools(registry: "ToolRegistry"):
    ...
    registry.register(Tool(
        ...
        allowed_roles=["doctor", "receptionist", "assistant", "admin", "super_admin"]
    ))
    ...
    registry.register(Tool(
        ...
        allowed_roles=["doctor", "receptionist", "accountant", "admin", "super_admin"]
    ))
    ...
    registry.register(Tool(
        ...
        parameters={
            "date": "تاريخ المواعيد (today/tomorrow/YYYY-MM-DD)"
        },
