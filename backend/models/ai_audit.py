...
class AILog(Base):
    ...
    trace_id = Column(String(50), index=True, nullable=False) # UUID for request lifecycle
    ...
    status = Column(String(20), index=True)       # SUCCESS, FAILURE, BLOCKED, NEEDS_CONFIRMATION
