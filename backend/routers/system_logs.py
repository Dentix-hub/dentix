...
def log_frontend_error(
    error: schemas.SystemErrorCreate,
    request: Request,
...
def get_system_errors(
    ...
    db: Session = Depends(get_db),
    current_user = Depends(get_current_user) # Only admins should see this, refined later
):
    ...
    return query.order_by(models.SystemError.created_at.desc()).offset(skip).limit(limit).all()
