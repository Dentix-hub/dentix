...
from backend.services.financial_visibility_service import get_financial_visibility_service
...
"""
    ...
    def filter_tool_results(self, patients: list) -> list:
        ...
        return [p for p in patients if getattr(p, 'id', None) in self.visible_patient_ids]
