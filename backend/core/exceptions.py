...
class AuthorizationException(BaseAppException):
    ...
    def __init__(
        self, message: str = "Access denied", required_role: Optional[str] = None
    ):
        super().__init__(
            message=message,
...
class AIServiceException(BaseAppException):
    ...
    def __init__(
        self, message: str = "AI service error", operation: Optional[str] = None
    ):
        super().__init__(
            message=message,
...
class TenantException(BaseAppException):
    ...
    def __init__(self, message: str = "Tenant operation error"):
        super().__init__(message=message, code="TENANT_ERROR", status_code=403)
