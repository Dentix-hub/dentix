...
from backend.models.inventory import Material, Batch, StockItem, ProcedureMaterialWeight
...
def test_smart_costing_flow():
    ...
    try:
        ...
        mat = inventory_service.create_material(
            schemas.inventory.MaterialCreate(name="Gold Amalgam", type="DIVISIBLE", base_unit="g"),
            tenant_id, db
        )
