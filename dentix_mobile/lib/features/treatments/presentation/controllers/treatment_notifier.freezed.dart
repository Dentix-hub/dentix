...
part of 'treatment_notifier.dart';
...
abstract class _Initial implements TreatmentState {
...
abstract class _Loading implements TreatmentState {
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'TreatmentState.loaded(treatments: $treatments, totalPages: $totalPages, currentPage: $currentPage, hasMore: $hasMore)';
  }
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'TreatmentState.error(message: $message)';
  }
...
abstract class _Error implements TreatmentState {
