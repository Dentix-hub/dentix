...
part of 'lab_order_notifier.dart';
...
/// @nodoc
class _$LabOrderStateCopyWithImpl<$Res, $Val extends LabOrderState>
    implements $LabOrderStateCopyWith<$Res> {
  _$LabOrderStateCopyWithImpl(this._value, this._then);
...
abstract class _Initial implements LabOrderState {
...
abstract class _Loading implements LabOrderState {
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'LabOrderState.loaded(labOrders: $labOrders, currentPage: $currentPage, totalPages: $totalPages, hasMore: $hasMore, filterStatus: $filterStatus, selectedPatientId: $selectedPatientId)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.selectedPatientId, selectedPatientId) ||
                other.selectedPatientId == selectedPatientId));
  }
...
abstract class _Loaded implements LabOrderState {
  ...
  int get totalPages;
  bool get hasMore;
  LabOrderStatus? get filterStatus;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'LabOrderState.error(message: $message)';
  }
...
abstract class _Error implements LabOrderState {
