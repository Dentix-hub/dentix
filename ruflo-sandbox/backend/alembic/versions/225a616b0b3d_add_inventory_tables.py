...
def upgrade() -> None:
    ...
    if "warehouses" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_warehouses_tenant_id"), "warehouses", ["tenant_id"], unique=False
        )
    ...
    if "materials" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_materials_tenant_id"), "materials", ["tenant_id"], unique=False
        )
    ...
    if "batches" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_batches_expiry_date"), "batches", ["expiry_date"], unique=False
        )
        op.create_index(op.f("ix_batches_id"), "batches", ["id"], unique=False)
        op.create_index(
            op.f("ix_batches_material_id"), "batches", ["material_id"], unique=False
        )

    # StockItem
    if "stock_items" not in existing_tables:
        op.create_table(
            "stock_items",
            sa.Column("id", sa.Integer(), nullable=False),
        ...
        op.create_index(
            op.f("ix_stock_items_batch_id"), "stock_items", ["batch_id"], unique=False
        )
        op.create_index(op.f("ix_stock_items_id"), "stock_items", ["id"], unique=False)
        op.create_index(
            op.f("ix_stock_items_warehouse_id"),
            "stock_items",
            ["warehouse_id"],
            unique=False,
        )
    ...
    # MaterialSession
    if "material_sessions" not in existing_tables:
        op.create_table(
            "material_sessions",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("stock_item_id", sa.Integer(), nullable=False),
            sa.Column(
                "opened_at", sa.DateTime(), server_default=sa.func.now(), nullable=True
            ),
        ...
        op.create_index(
            op.f("ix_material_sessions_id"), "material_sessions", ["id"], unique=False
        )
        op.create_index(
            op.f("ix_material_sessions_stock_item_id"),
            "material_sessions",
            ["stock_item_id"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_material_sessions_stock_item_id"), table_name="material_sessions"
    )
