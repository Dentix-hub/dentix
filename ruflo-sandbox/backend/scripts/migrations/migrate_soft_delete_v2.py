...
def migrate_soft_delete():
    ...
    try:
        ...
        if "is_deleted" not in columns:
            ...
            db.execute(
                text(
                    f"ALTER TABLE patients ADD COLUMN is_deleted BOOLEAN DEFAULT {bool_default}"
                )
            )
        ...
        if "deleted_at" not in columns:
            ...
            db.execute(
                text(f"ALTER TABLE patients ADD COLUMN deleted_at {datetime_type}")
            )
        ...
        if "is_deleted" not in columns:
            ...
            db.execute(
                text(
                    f"ALTER TABLE appointments ADD COLUMN is_deleted BOOLEAN DEFAULT {bool_default}"
                )
            )
        ...
        if "deleted_at" not in columns:
            ...
            db.execute(
                text(f"ALTER TABLE appointments ADD COLUMN deleted_at {datetime_type}")
            )
