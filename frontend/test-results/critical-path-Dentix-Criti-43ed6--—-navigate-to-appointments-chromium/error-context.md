...
- Name: critical-path.spec.js >> Dentix Critical Path >> 3 — navigate to appointments
- Location: e2e\critical-path.spec.js:27:3
...
Locator: locator('h1, h2, [data-testid="appointments-title"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('h1, h2, [data-testid="appointments-title"]')
