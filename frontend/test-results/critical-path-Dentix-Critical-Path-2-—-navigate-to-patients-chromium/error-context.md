...
- Name: critical-path.spec.js >> Dentix Critical Path >> 2 — navigate to patients
- Location: e2e\critical-path.spec.js:20:3
...
Locator: locator('h1, h2, [data-testid="patients-title"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('h1, h2, [data-testid="patients-title"]')
