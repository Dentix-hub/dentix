                                    ...
                                    <tr key={emp.id} className="hover:bg-surface-hover transition-colors">
                                        ...
                                        <td className="p-4">
                                            {emp.is_new_this_month ? (
                                                <span className="text-warning font-bold text-xs" title="تعيين جديد هذا الشهر">
                                                    {emp.days_worked} {t('billing.salaries.new_employee_day')}
                                                </span>
                                            ) : (
                                            ...
                                            {emp.is_paid ? (
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => handleDeleteSalaryPayment(emp.payment.id)}
