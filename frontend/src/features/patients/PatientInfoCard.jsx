    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col md:flex-row justify-between md:items-center gap-4">
            ...
            <div className="flex gap-2">
                <button onClick={onPrescription} className="flex items-center gap-2 px-4 py-2 bg-teal-100 dark:bg-teal-900/30 font-bold rounded-lg text-teal-700 dark:text-teal-300 hover:bg-teal-200 dark:hover:bg-teal-900/50 transition-colors">
