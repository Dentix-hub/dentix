        ...
        >
            <div className="relative mb-8">
                ...
                <motion.div 
                    ...
                    className="relative bg-gradient-to-br from-slate-50 to-slate-200 dark:from-slate-800 dark:to-slate-900 p-8 rounded-[2rem] shadow-xl ring-1 ring-white/50 dark:ring-white/10"
                >
